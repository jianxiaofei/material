...
{    
    ...
    function loadView(routeObject, viewElement, viewHtml) {
        ...
        routeObject.controller(view, model, routeObject.route); //get the resultant model from the controller of the current route
    ...
    function startMvc()
    {
        ...
        var param = pageHash.split('?');
        routeName = param[0];
        // routeName = routeName.replace('/', '_'); //get the name of the route from the hash  
